        ...
        child: Column(
          children: [
            const Padding(
              ...
              child: Text(
                'Day trading is the act of buying and selling a financial instrument within the same day or even multiple times over the course of a day. Taking advantage of small price moves can be a lucrative game if it is played correctly. Yet, it can be dangerous for beginners and anyone else who does not adhere to a well-thought-out strategy.Not all brokers are suited for the high volume of trades day trading generates. On the other hand, some fit perfectly with day traders.',
                style: TextStyle(
            ...
            Image.asset('images/sammy-man-trades-profitable-stocks.png'),
          ],
        ),
      ),
    );
